...
let RolesGuard = class RolesGuard {
    ...
    async canActivate(context) {
        const classRoles = this.reflector.getAllAndOverride(decorators_1.ROLES_KEY, [
            context.getClass(),
        ]) || [];
        const methodRoles = this.reflector.getAllAndOverride(decorators_1.ROLES_KEY, [
            context.getHandler(),
        ]) || [];
        const requiredFunctionalities = Array.from(new Set([...classRoles, ...methodRoles]));
