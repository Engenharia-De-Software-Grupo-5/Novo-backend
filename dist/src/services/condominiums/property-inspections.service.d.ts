...
export declare class PropertyInspectionsService {
    private readonly repo;
    private readonly minio;
    private readonly allowedExtensions;
    constructor(repo: PropertyInspectionsRepository, minio: MinioClientService);
    ...
    getDownloadUrl(condominiumId: string, propertyId: string, inspectionId: string): Promise<{
        url: string;
    }>;
