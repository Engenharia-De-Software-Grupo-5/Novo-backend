...
export declare class PropertyDocumentsRepository {
    ...
    create(data: {
        ...
        extension: string;
        size: number;
    }): import(".prisma/client").Prisma.Prisma__PropertyDocumentsClient<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        deletedAt: Date | null;
    ...
    softDelete(condominiumId: string, propertyId: string, documentId: string): Promise<void>;
}
